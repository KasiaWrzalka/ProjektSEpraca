...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        zawody = {'ESTJ': ["administrator", "agent ubezpieczeniowy", "audytor", "bibliotekarz", "coach", "detektyw", "dyrektor", "ekonomista", "farmaceuta", "informatyk", "inspektor", "inżynier", "kierownik biura", "koordynator projektu", "księgowy", "kucharz", "menedżer", "nauczyciel", "naukowiec", "pracownik banku", "policjant", "polityk", "pracownik administracji rządowej", "prawnik", "przedstawiciel handlowy", "sędzia", "technik", "urzędnik", "wykładowca akademicki", "żołnierz"],
                  'ESFJ': ["adwokat", "aktor", "agent biura podróży", "agent biura nieruchomości", "doradca finansowy", "duchowny", "farmaceuta", "fizjoterapeuta", "księgowy", "lekarz", "logopeda", "menedżer", "nauczyciel", "optyk", "pedagog", "pielęgniarz", "pracownik biura obsługi klienta", "pracownik działu kadr", "pracownik pomocy społecznej", "przedstawiciel handlowy", "recepcjonista", "restaurator", "rehabilitant", "sanitariusz", "specjalista ds. marketingu", "specjalista ds. PR", "sprzedawca", "terapeuta", "trener", "wychowawca przedszkolny"],
                  'ESTP': ["agent biura podróży", "agent biura nieruchomości", "agent ubezpieczeniowy", "aktor", "animator", "antyterrorysta", "doradca finansowy", "elektronik", "elektryk", "fizjoterapeuta", "fotograf", "inżynier", "kierowca", "logistyk", "pilot wycieczek", "policjant", "ochroniarz", "prezenter", "pracownik budowlany", "pracownik centrum zarządzania kryzysowego", "przedsiębiorca", "przedstawiciel handlowy", "przewodnik turystyczny", "ratownik", "sportowiec", "sprzedawca", "strażak", "ślusarz", "trener", "żołnierz"],
                  'ISFP': ["artysta", "botanik", "dekorator wnętrz", "florysta", "fotograf", "fryzjer", "grafik", "groomer", "kelner", "kucharz", "lekarz", "leśniczy", "malarz", "mechanik", "muzyk", "nauczyciel wychowania przedszkolnego", "ogrodnik", "pedagog wczesnoszkolny", "pracownik biura podróży", "pracownik centrum zarządzania kryzysowego", "pracownik pomocy społecznej", "projektant mody", "przyrodnik", "psycholog", "ratownik", "rzemieślnik", "stylista", "terapeuta", "trener", "weterynarz"],
                  'ENFJ': ["agent biura podróży", "aktor", "coach", "doradca", "duchowny", "dyplomata", "kierownik", "konsultant", "lekarz", "menedżer", "muzyk", "nauczyciel", "naukowiec", "pisarz", "policjant", "polityk", "pracownik pomocy społecznej", "przedstawiciel handlowy", "psychiatra", "psycholog", "rehabilitant", "redaktor", "reporter", "sanitariusz", "specjalista ds. marketingu", "specjalista ds. PR", "specjalista ds. pracowniczych", "szkoleniowiec", "terapeuta", "wykładowca akademicki"],
                  'ENTJ': ["administrator", "analityk kredytowy", "analityk systemów komputerowych", "CEO", "coach", "dyrektor artystyczny", "dyrektor wykonawczy", "dyrektor ds. marketingu", "dyrektor ds. rozwoju", "dziennikarz", "informatyk", "inwestor", "koordynator projektu", "menedżer", "muzyk", "naukowiec", "pisarz", "planista", "polityk", "pracownik administracji rządowej", "prawnik", "przedsiębiorca", "psycholog", "reporter", "sędzia", "specjalista ds. kadr", "specjalista ds. kredytów", "specjalista ds. marketingu", "specjalista ds. PR", "wykładowca akademicki"],
                  'ENFP': ["agent ubezpieczeniowy", "aktor", "doradca", "duchowny", "dyrektor artystyczny", "dziennikarz", "dyplomata", "konsultant", "logopeda", "malarz", "mediator", "menedżer", "muzyk", "nauczyciel", "naukowiec", "organizator imprez", "pisarz", "polityk",  "pracownik pomocy społecznej", "przedsiębiorca", "projektant wnętrz", "przedstawiciel handlowy", "psycholog", "psychiatra", "redaktor", "reporter", "sanitariusz", "specjalista ds. PR", "sprzedawca", "terapeuta"],
                  'INFP': ["aktor", "artysta", "blogger", "coach", "dekorator", "doradca", "duchowny", "dyrektor artystyczny", "działacz społeczny", "dziennikarz", "fizjoterapeuta", "konsultant", "koordynator projektu", "mediator", "muzyk", "nauczyciel", "naukowiec", "pisarz", "pracownik pomocy społecznej", "projektant wnętrz", "psychiatra", "psycholog", "redaktor", "specjalista ds. multimediów", "specjalista ds. pracowniczych", "szkoleniowiec", "terapeuta", "tłumacz", "wydawca", "wykładowca akademicki"],
                  'ENTP': ["agent biura nieruchomości", "aktor", "analityk kredytowy", "analityk systemów komputerowych", "artysta", "doradca finansowy", "dyrektor artystyczny", "dziennikarz", "fotograf", "inwestor", "inżynier", "koordynator projektu", "logistyk", "makler", "muzyk", "naukowiec", "organizator imprez", "pisarz", "planista", "polityk", "prawnik", "programista komputerowy", "przedsiębiorca", "przedstawiciel handlowy", "psychiatra", "psycholog", "reporter", "rzecznik prasowy", "specjalista ds. marketingu", "specjalista ds. PR"],
                  'ISTJ': ["administrator", "analityk systemów komputerowych", "archiwista", "audytor", "bibliotekarz", "detektyw", "dyrektor finansowy", "dyrektor wykonawczy", "farmaceuta", "informatyk", "inspektor", "inżynier", "kontroler", "księgowy", "lekarz", "logistyk", "lotnik", "nauczyciel nauk ścisłych", "mechanik", "menedżer", "policjant", "prawnik", "programista komputerowy", "przedsiębiorca", "rewident", "rolnik", "sędzia", "technik", "urzędnik żołnierz"],
                  'INTP': ["analityk", "archeolog", "architekt", "chemik", "detektyw", "doradca finansowy", "dyrektor artystyczny", "ekonomista", "filozof", "fotograf", "historyk", "informatyk", "inwestor", "inżynier", "językoznawca", "matematyk", "muzyk", "naukowiec", "pisarz", "planista", "prawnik", "producent filmowy", "programista", "rzeczoznawca", "specjalista ds. badań i rozwoju", "specjalista ds. oceny ryzyka", "specjalista ds. strategii", "specjalista ds. systemów komputerowych", "tłumacz", "nauczyciel akademicki"],
                  'INFJ': ["artysta", "bibliotekarz", "coach", "designer", "dietetyk", "doradca", "duchowny", "dziennikarz", "filmowiec", "fizjoterapeuta", "fotograf", "konsultant", "koordynator projektu", "lekarz", "mediator", "muzyk", "nauczyciel", "naukowiec", "opiekun prawny", "pedagog", "pisarz", "pracownik pomocy społecznej", "producent telewizyjny", "psycholog", "redaktor", "rehabilitant", "sanitariusz", "socjolog", "specjalista ds. pracowniczych", "terapeuta"],
                  'ISFJ': ["administrator", "agent biura nieruchomości", "agent ubezpieczeniowy", "aktor", "bibliotekarz", "dekorator wnętrz", "doradca", "duchowny", "fizjoterapeuta", "kierownik biura", "księgowy", "kurator", "lekarz", "menedżer", "muzyk", "nauczyciel", "ogrodnik", "pracownik budowlany", "pracownik pomocy społecznej", "projektant", "przedsiębiorca", "psycholog", "rolnik", "sanitariusz", "specjalista ds. pracowniczych", "sprzedawca technik medyczny", "terapeuta", "trener", "weterynarz"],
